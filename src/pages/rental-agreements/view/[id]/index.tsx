...
import { getRentalAgreementById } from 'apiSdk/rental-agreements';
...
function RentalAgreementViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Rental Agreement Detail View
          </Text>
          {hasAccess('rental_agreement', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/rental-agreements/edit/${data?.id}`} passHref legacyBehavior>
              <Button
