  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Construction Tool Rental - Your one-stop solution for easy and convenient rental of construction tools from multiple outlets."
        />
      </Head>
      ...
      <Stack minH={'100vh'} direction={{ base: 'column', md: 'row' }}>
        <Flex p={8} flex={1} align={'center'} justify={'center'}>
          <Stack position="relative" spacing={6} w={'full'} maxW={'lg'}>
            ...
            <Text fontSize={{ base: 'md', lg: 'lg' }} color={'gray.500'}>
              {`Welcome to Construction Tool Rental - Your one-stop solution for easy and convenient rental of construction tools from multiple outlets.`}
            </Text>
        ...
        <Flex position="relative" flex={1}>
          <Image
            src={
              'https://images.unsplash.com/photo-1541888946425-d81bb19240f5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjb25zdHJ1Y3Rpb24lMjB0b29scyUyQ3JlbnRhbHxlbnwwfHx8fDE2ODg0Njg2MzJ8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt={'Login Image'}
            objectFit={'cover'}
          />
